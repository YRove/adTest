    ...
    export default {
        data() {
            return {
                ...
                form: {},
                type: 0,
                activeIndex: '/aside/basePersionalInformation'
            }
        },
        created() {
        ...
        methods: {
            ...
            selectData(code) {
                //   const isBigEnough = x => x === code;
                function isBigEnough(x) {
                    return x.institutionCode === code;
                }
            }
        },
        beforeDestroy() {
            this.$root.eventHub.$off('onSubmit');
        },
    }
</script>
